...
struct CoordinateTransformations {
    ...
    /* Coordinate systems:
     *
     * 1) Logical device coordinate system:
     ...
     *
     * 4) NDC - normalized device coordinates are defined w.r.t a coordinate frame which is located at the center of a
     *    2x2x2 cube.
     *
    ...
    */
    ...
    inline void convert_from_image_coordinates_to_logical_device_coordinates(const osg::Vec2d& img_coord, osg::Vec2d& dev_coord);
    inline void convert_from_logical_device_coordinates_to_image_coordinates(const osg::Vec2d& dev_coord, osg::Vec2d& img_coord);

    // logical device coordinates <<->> viewport coordinates
    inline void convert_from_viewport_coordinates_to_logical_device_coordinates(const osg::Vec2d& vp_coord, osg::Vec2d& dev_coord);
    inline void convert_from_logical_device_coordinates_to_viewport_coordinates(const osg::Vec2d& dev_coord, osg::Vec2d& vp_coord);
    ...
    void convert_from_logical_device_coordinates_to_projected_coordinates(const osg::Vec2d& dev_coord, osg::Vec2d& prj_coord);
