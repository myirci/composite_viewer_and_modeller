...
// axis constraints:
#define wxID_MODEL_CONSTRAINTS_NO_AXIS_CONSTRAINT       SCENE_GRAPH_FRAME_FIRST_ID + 36
#define wxID_MODEL_CONSTRAINTS_LINEAR_AXIS              SCENE_GRAPH_FRAME_FIRST_ID + 37
#define wxID_MODEL_CONSTRAINTS_PLANAR_AXIS              SCENE_GRAPH_FRAME_FIRST_ID + 38
#define wxID_MODEL_CONSTRAINTS_CONSTANT_DEPTH           SCENE_GRAPH_FRAME_FIRST_ID + 39

#define wxID_MODES_PERSPECTIVE_PROJECTION               SCENE_GRAPH_FRAME_FIRST_ID + 40
#define wxID_MODES_ORTHOGRAPHIC_PROJECTION              SCENE_GRAPH_FRAME_FIRST_ID + 41
